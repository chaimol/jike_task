    ...
    $.ajax({
      ...
      dataType:'json', 
       success:function(result){
        ...
        var trs = ""; 
        //遍历返回的数组，拼合html
         $(result).each(function (n,value) {  
              trs = "<div class='index-list-item'>" +"<div class='index-list-title'> "+value.newstitle + 
              "</div> <div class='index-list-content'>" + value.newscontent + 
              "</div> <div class='index-list-bottom'> <b class='tip-time'>"+value.newstime+"</b></div> </div>";  
              tbody += trs;
          });  
...
$(".nav-title").each(function(index){
	$(this).click(function(){
        ...
        $(".nav_text").removeClass("under_line");
        
        $(".nav_text").eq(newstype).addClass("under_line");
